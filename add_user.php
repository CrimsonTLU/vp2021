<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        if(isset($_POST["user_data_submit"])){
			...
			}else { $firstname_error = "Palun sisesta oma eesnimi!";
			...
			}else { $surname_error = "Palun sisesta oma perekonnanimi!";
			...
			}else { $gender_error = "Palun märgi oma sugu!";
			...
			}else { $birth_day_error = "Palun vali sünni päev!";
			...
			}else { $birth_month_error = "Palun vali sünni kuu!";
			...
			}else { $birth_year_error = "Palun vali sünni aasta!";
			...
			if(isset($_POST["confirm_password_input"]) and !empty($_POST["confirm_password_input"])) {
				if($_POST["confirm_password_input"] != $_POST["password_input"]){
					$confirm_password_error = "Sisestatud salasõnad ei ühti!";
				}
				
			}else { $confirm_password_error = "Palun sisesta salasõna kaks korda!";
